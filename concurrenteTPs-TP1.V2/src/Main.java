...
public class Main {
    public static void main(String[] args) {
        ...
        Thread procesoUnoHiloDos = new Thread(new ProcesoUno(contenedor, 50));
          ...
          Thread procesoDosHiloUno = new Thread(new ProcesoDos(contenedor, 5));
          Thread procesoDosHiloDos = new Thread(new ProcesoDos(contenedor, 5));
          Thread procesoDosHiloTres = new Thread(new ProcesoDos(contenedor, 5));
